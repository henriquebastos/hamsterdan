...
ANTHROPIC_AGENT_API_KEY=op://hamsterdan-ops/agent-api-key/credential
...
OP_SERVICE_ACCOUNT_TOKEN_VPS=op://hamsterdan-ops/service-account-sa-hamsterdan-prod-exe/credential
