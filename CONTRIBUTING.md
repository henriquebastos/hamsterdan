...
The pinned Petrus dependency is currently private. A public clone alone cannot
install or run the full application. Dependency access and public CI remain
follow-up work; do not submit credentials to make a build pass.

For contributors who already have dependency access, follow the
