...
Every Delivery Story is `Planned`. None is pulled by creating this Value. Each
selected tracer must expand into reviewable User and Technical Stories and pass
its own API-strengthening Plan Checkpoint before implementation.
